  ...
  return (
    <header
      className={`sticky top-0 z-50 bg-cream transition-shadow ${
        scrolled ? "shadow-[0_2px_12px_rgba(11,40,49,0.08)]" : ""
      }`}
    >
      <div className="mx-auto max-w-[1200px] px-6 flex h-[72px] items-center justify-between gap-4">
        ...
        <a
          href="#"
          className="inline-flex h-[52px] items-center rounded-full bg-amber-500 px-7 text-[16px] font-bold text-ink-900 transition-opacity hover:opacity-90"
        >
          {copy.ctaPrimary}
        </a>
      </div>
