      ...
      <div className="gradient-dark relative overflow-hidden rounded-[20px] md:rounded-[32px] p-6 md:p-[48px] text-white">
        ...
        <div className="relative z-10">
          <h1 className="max-w-[820px] text-[32px] leading-[1.05] md:text-[56px]">
            Учёба без ночных <Marker className="text-orange-500"><span className="whitespace-nowrap text-white">дедлайнов</span></Marker>
          </h1>
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {scenarios.map((s) => (
            <a 
              key={s.id} 
              href="#" 
              className="group relative flex flex-col rounded-[24px] bg-white p-6 transition-all duration-200 hover:-translate-y-[2px] hover:border-orange-500 hover:shadow-[0_8px_24px_rgba(11,40,49,0.18)] border border-[#E6E9EC] cursor-pointer"
            >
